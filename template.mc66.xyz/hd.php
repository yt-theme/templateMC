...
<!--Baidu display logo-->
<div class="dnone"><img width="121" src="images/nav-huodong.jpg" alt="logo" /></div>
...
<div id="fh5co-page">
    ...
    <div class="container">
      <nav role="navigation">
        <ul class="pull-left left-menu">
		  ...
		  <li class="active"><a href="hd.php">平台活动区</a></li>
        </ul>
  ...
  <!-- END #fh5co-hero -->
    ...
    <div class="container">
      <div class="row">
		<div class="col-md-4 col-sm-6 col-xs-6 animate-box"><a href="hd_gwfree/index.html" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="hd_gwfree/logo.png" alt="免费官网①" class="img-responsive lazy">
