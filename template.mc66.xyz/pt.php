...
<div id="fh5co-page">
    ...
    <div class="container">
      <nav role="navigation">
        <ul class="pull-left left-menu">
          <li><a href="ydy.php">引导页模板</a></li>
          <li><a href="gw.php">官网模板</a></li>
          <li class="active"><a href="pt.php">其他网页配套</a></li>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">其他网页配套</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- END #fh5co-hero -->
    ...
    <div class="container">
      <div class="row">
	      <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><a href="http://skin.template.mc66.xyz/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="pt_pfz/logo.png" alt="皮肤站" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>皮肤站</h2>
            <p>25/月</p>
          </div>
          </a> </div>		
          <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><a href="pt_lt/index.php" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="pt_lt/logo.png" alt="服务器官方论坛制作" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>基础美化论坛</h2>
            <p>30/月</p>
          </div>
          </a> </div>
		  <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><a href="pt_xhtx/index.html" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="pt_xhtx/logo.png" alt="网站雪花特效" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>网站雪花特效</h2>
            <p>维护</p>
          </div>
          </a> </div>
		  <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><a href="pt_sp/index.html" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="pt_sp/logo.png" alt="宣传视频外链" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>宣传视频外链</h2>
            <p>15/月</p>
          </div>
          </a> </div>		  
		  <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><a href="pt_jfpt/index.php" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="pt_jfpt/logo.png" alt="禁封平台 class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>禁封平台</h2>
            <p>25/月</p>
          </div>
