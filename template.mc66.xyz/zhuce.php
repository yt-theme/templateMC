...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">注册成为会员</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    <div class="container animate-box">
		<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a>平台暂时不开放会员注册。</div>
        <form method="post" action="plugin/vip.php">
         <input type="hidden" name="reg" value="1">
        <div class="col-md-12">
            <div class="form-group">
              <input id="number" name="number" type="text" class="form-control" maxlength="30" placeholder="请输入注册码" required>
              <span class="help-block text-center">（暂不发放注册码）</span>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
              <input id="username" name="username" type="text" class="form-control" maxlength="20" placeholder="请输入纯数字账号" required>
            	 <span class="help-block text-center">（说明：账号建议使用QQ号/手机号，至少5位数及以上。）</span>
            </div>
        </div>
        
        <div class="col-md-12">
            <div class="form-group">
              <input id="password" name="password" type="password" class="form-control" placeholder="请设置登录密码" maxlength="30" required>
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
		  ...
		  <p class="fh5co-sub-lead animate-box">4.本网站所有产品说明最终解释权归噬魂网络所有。</p>
        </div>
      </div>
    </div>
  </div>
